...
const Body = () => {
  ...
  useEffect(() => {
    ...
    refElement?.current?.forEach((ele) => {
      if (ele) observer1?.observe(ele);
    });
  ...
  return (
    <div className="min-h-screen w-full bg-[#3A3A3A] overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-20 lg:px-40 2xl:px-20 3xl:px-6 flex flex-col gap-16 md:gap-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ">
          {/* Left Content */}
          <div
            className="flex flex-col items-center lg:items-start text-center lg:text-left gap-8 fadeUp"
            id="left"
          >
            {/* Badge */}
            ...
            <p className="text-base sm:text-lg text-gray-400 leading-relaxed max-w-lg">
              A modern social platform to meet new people, share moments, and
              chat in real-time — without limits.
            </p>
            ...
            <div className="relative w-full max-w-[350px] bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden transform lg:rotate-8 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="flex flex-col gap-4 p-5 h-[300px] overflow-y-auto">
                {messages.map((msg) => (
                  ...
                  >
                    <div
                      className={`px-4 py-2.5 text-sm max-w-[85%] shadow-sm ${
                        msg.type === "sent"
          ...
          {[
            {
              ...
              desc: "Instant messaging with live delivery status.",
              icon: <BsChatSquareText />,
              color: "blue",
            },
            {
              title: "Connect with people",
              desc: "Discover and connect with people who share your interests.",
              icon: <FaUserFriends />,
              color: "red",
            },
            {
            ...
            >
              ...
              <div
                className={`flex items-center gap-2 text-${feature.color}-400 text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity`}
              >
                <span>Learn more</span>
                <IoArrowForward />
              </div>
